...
//     private final ExamRepository scheduleRepository;
...
//         List<ExamEntity> schedules = scheduleRepository.findActiveSchedules(today, limitThree);
...
//         List<ExamEntity> schedules = scheduleRepository.findUpcomingSchedules(today, limitThree);
...
//         List<ExamEntity> schedules = scheduleRepository.findActiveSchedules(today, Pageable.unpaged());
...
//         List<ExamEntity> schedules = scheduleRepository.findSchedulesByYears(thisYear, nextYear);
...
//         // 특정 연도의 일정만 조회
//         List<ExamEntity> schedules = scheduleRepository.findSchedulesByYear(year);
...
//     */
//     private ScheduleActiveResponseDTO convertToActiveDto(ExamEntity schedule) {
//         CertificateEntity cert = schedule.getCertificate();
